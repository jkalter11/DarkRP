...
RegisterNetEvent("darkrp:changeGender")
AddEventHandler("darkrp:changeGender", function(gender)
...
AddEventHandler("darkrp:OutfitsValidate", function(target, e)
  if (e == 0) then
...
AddEventHandler("darkrp:OutfitsVal", function(target, o, h)
  local k = tonumber(o)
  local t = tonumber(h)
  local i = 0
  for _, item in pairs(outfits) do
    if item.id == t then
      ...
      if i == k then
        ...
        TriggerServerEvent("darkrp:getOutfit", args)
        break
      end
    end
  end
...
AddEventHandler("darkrp:JobOutfit", function(o, h)
  local k = tonumber(o)
  local t = tonumber(h)
  local i = 0
  for _, item in pairs(outfits) do
