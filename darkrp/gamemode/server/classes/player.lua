...
function Player:setPermissions(p)
	TriggerEvent("darkrp:setPlayerData", self.source, "permission_level", p, function(response, success)
...
function Player:setMoney(m)
	...
	if((prevMoney - newMoney) < 0)then
		TriggerClientEvent("darkrp:addedMoney", self.source, math.abs(prevMoney - newMoney))
	else
		TriggerClientEvent("darkrp:removedMoney", self.source, math.abs(prevMoney - newMoney))
	end

	TriggerClientEvent('darkrp:activateMoney', self.source , self.money)
end
...
function Player:addMoney(m)
	...
	TriggerClientEvent("darkrp:addedMoney", self.source, m)
	TriggerClientEvent('darkrp:activateMoney', self.source , self.money)
end
...
function Player:removeMoney(m)
	...
	TriggerClientEvent("darkrp:removedMoney", self.source, m)
	TriggerClientEvent('darkrp:activateMoney', self.source , self.money)
end
...
function Player:setDMoney(m)
	...
	if((prevMoney - newMoney) < 0)then
		TriggerClientEvent("darkrp:adddBalance", self.source, math.abs(prevMoney - newMoney))
	else
		TriggerClientEvent("darkrp:removedBalance", self.source, math.abs(prevMoney - newMoney))
	end

	TriggerClientEvent('darkrp:updatedBalance', self.source , self.dirtymoney)
end
...
function Player:addDMoney(m)
	...
	TriggerClientEvent("darkrp:adddBalance", self.source, m)
	TriggerClientEvent('darkrp:updatedBalance', self.source , self.dirtymoney)
end
...
function Player:removeDMoney(m)
	...
	TriggerClientEvent("darkrp:removedBalance", self.source, m)
	TriggerClientEvent('darkrp:updatedBalance', self.source , self.dirtymoney)
end
